...
//
// Style: style_led_analog_clock
//

void init_style_style_led_analog_clock_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_shadow_width(style, 0);
    lv_style_set_shadow_spread(style, 0);
};

lv_style_t *get_style_style_led_analog_clock_MAIN_DEFAULT() {
    static lv_style_t *style;
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_led_analog_clock_MAIN_DEFAULT(style);
    }
    return style;
};

void add_style_style_led_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_style_led_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_style_led_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_style_led_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

//
// Style: style_line_hr_analog_clock
//
...
lv_style_t *get_style_style_line_hr_analog_clock_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_line_hr_analog_clock_MAIN_DEFAULT(style);
    }
    return style;
};

void add_style_style_line_hr_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_style_line_hr_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_style_line_hr_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_style_line_hr_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

//
// Style: style_line_min_analog_clock
//
...
lv_style_t *get_style_style_line_min_analog_clock_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_line_min_analog_clock_MAIN_DEFAULT(style);
    }
    return style;
};

void add_style_style_line_min_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_style_line_min_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_style_line_min_analog_clock(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_style_line_min_analog_clock_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
...
void add_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const AddStyleFunc add_style_funcs[] = {
        ...
        add_style_style_led_analog_clock,
        add_style_style_line_hr_analog_clock,
        add_style_style_line_min_analog_clock,
    };
...
void remove_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const RemoveStyleFunc remove_style_funcs[] = {
        ...
        remove_style_style_led_analog_clock,
        remove_style_style_line_hr_analog_clock,
        remove_style_style_line_min_analog_clock,
    };
