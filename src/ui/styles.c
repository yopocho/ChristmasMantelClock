...
void init_style_style_spinboxes_digital_time_MAIN_DEFAULT(lv_style_t *style) {
...
lv_style_t *get_style_style_spinboxes_digital_time_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinboxes_digital_time_MAIN_DEFAULT(style);
    }
    return style;
};

void init_style_style_spinboxes_digital_time_MAIN_FOCUS_KEY(lv_style_t *style) {
    lv_style_set_outline_opa(style, 0);
    lv_style_set_border_color(style, lv_color_hex(0xffffffff));
...
lv_style_t *get_style_style_spinboxes_digital_time_MAIN_FOCUS_KEY() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinboxes_digital_time_MAIN_FOCUS_KEY(style);
    }
    return style;
};

void init_style_style_spinboxes_digital_time_MAIN_FOCUSED(lv_style_t *style) {
    lv_style_set_border_color(style, lv_color_hex(0xffffffff));
    lv_style_set_border_width(style, 2);
    lv_style_set_border_opa(style, 255);
    lv_style_set_border_side(style, LV_BORDER_SIDE_BOTTOM);
...
lv_style_t *get_style_style_spinboxes_digital_time_MAIN_FOCUSED() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinboxes_digital_time_MAIN_FOCUSED(style);
    }
    return style;
};

void init_style_style_spinboxes_digital_time_CURSOR_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_opa(style, 0);
};
...
lv_style_t *get_style_style_spinboxes_digital_time_CURSOR_DEFAULT() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinboxes_digital_time_CURSOR_DEFAULT(style);
    }
    return style;
};
...
void add_style_style_spinboxes_digital_time(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_style_spinboxes_digital_time_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_style_spinboxes_digital_time_MAIN_FOCUS_KEY(), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_add_style(obj, get_style_style_spinboxes_digital_time_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_add_style(obj, get_style_style_spinboxes_digital_time_CURSOR_DEFAULT(), LV_PART_CURSOR | LV_STATE_DEFAULT);
};

void remove_style_style_spinboxes_digital_time(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_style_spinboxes_digital_time_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_style_spinboxes_digital_time_MAIN_FOCUS_KEY(), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_remove_style(obj, get_style_style_spinboxes_digital_time_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_remove_style(obj, get_style_style_spinboxes_digital_time_CURSOR_DEFAULT(), LV_PART_CURSOR | LV_STATE_DEFAULT);
};
...
void add_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const AddStyleFunc add_style_funcs[] = {
        ...
        add_style_style_spinboxes_digital_time,
...
void remove_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const RemoveStyleFunc remove_style_funcs[] = {
        ...
        remove_style_style_spinboxes_digital_time,
